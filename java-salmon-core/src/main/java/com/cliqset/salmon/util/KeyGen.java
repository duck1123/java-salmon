	...
	public static void main(String[] args) {
		try {
			...
			for (int x = 0; x < numKeys; x++) {
			    ...
			    fos.write(MagicSigUtil.encode(getBytes(publicSpec.getModulus())));
			    
			    fos.write(".".getBytes("ASCII"));
			    
			    fos.write(MagicSigUtil.encode(getBytes(publicSpec.getPublicExponent())));
		
			    fos.write(".".getBytes("ASCII"));
			    
			    fos.write(MagicSigUtil.encode(getBytes(privateSpec.getPrivateExponent())));
