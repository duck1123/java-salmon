...
public class CompactMagicEnvelopeDeserializerTest {

	@Test
	public void testDeserializeOne() {
		try {
			MagicEnvelope me = new CompactMagicEnvelopeDeserializer().deserialize(CompactMagicEnvelopeDeserializerTest.class.getResourceAsStream("/MagicEnvelopeOne.compact"));
