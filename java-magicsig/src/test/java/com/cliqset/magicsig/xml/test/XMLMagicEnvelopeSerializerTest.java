...
*/
package com.cliqset.magicsig.xml.test;
...
public class XMLMagicEnvelopeSerializerTest {
	...
	public void testNullOutputStream() {
		try {
			new XMLMagicEnvelopeSerializer().serialize(new MagicEnvelope(), null);
	...
	public void testNullMagicEnvelope() {
		try {
			new XMLMagicEnvelopeSerializer().serialize(null, null);
			Assert.fail("Should have received a IllegalArgumentException");
		} catch (IllegalArgumentException iae) {
	...
	public static byte[] getBytes(String filename) {
		...
		InputStream data = XMLMagicEnvelopeSerializerTest.class.getResourceAsStream(filename);
		try {
			int i;
