...
public class XMLMagicEnvelopeDeserializerTest {
	...
	public void testDeserializeOne() {
		try {
			MagicEnvelope me = new XMLMagicEnvelopeDeserializer().deserialize(XMLMagicEnvelopeDeserializerTest.class.getResourceAsStream("/MagicEnvelopeOne.xml"));
	...
	public void testNullInputStream() {
		try {
			new XMLMagicEnvelopeDeserializer().deserialize(null);
